...
/* E2293C 802B738C 3C04802B */  lui       $a0, %hi(D_802B7C78_E23228)
/* E22940 802B7390 8C847C78 */  lw        $a0, %lo(D_802B7C78_E23228)($a0)
...
/* E22970 802B73C0 3C068011 */  lui       $a2, %hi(D_8010EBB0_C7A160)
/* E22974 802B73C4 24C6EBB0 */  addiu     $a2, $a2, %lo(D_8010EBB0_C7A160)
...
/* E229F8 802B7448 3C03802B */  lui       $v1, %hi(D_802B7C78_E23228)
/* E229FC 802B744C 8C637C78 */  lw        $v1, %lo(D_802B7C78_E23228)($v1)
...
.L802B7528:
/* E22AD8 802B7528 3C02802B */  lui       $v0, %hi(D_802B7C78_E23228)
/* E22ADC 802B752C 8C427C78 */  lw        $v0, %lo(D_802B7C78_E23228)($v0)
...
/* E22AF8 802B7548 3C018016 */  lui       $at, %hi(D_8015A57A_CC5B2A)
/* E22AFC 802B754C A020A57A */  sb        $zero, %lo(D_8015A57A_CC5B2A)($at)
/* E22B00 802B7550 8CA20004 */  lw        $v0, 4($a1)
/* E22B04 802B7554 2403FEFF */  addiu     $v1, $zero, -0x101
/* E22B08 802B7558 3C018011 */  lui       $at, %hi(D_8010C93C_C77EEC)
/* E22B0C 802B755C AC20C93C */  sw        $zero, %lo(D_8010C93C_C77EEC)($at)
