...
/* 9C6ADC 802416FC 3C038025 */  lui       $v1, %hi(D_80251C64_9D7044)
/* 9C6AE0 80241700 8C631C64 */  lw        $v1, %lo(D_80251C64_9D7044)($v1)
/* 9C6AE4 80241704 8C620000 */  lw        $v0, ($v1)
/* 9C6AE8 80241708 3C048025 */  lui       $a0, %hi(D_80251C68_9D7048)
/* 9C6AEC 8024170C 8C841C68 */  lw        $a0, %lo(D_80251C68_9D7048)($a0)
...
.L80241724:
/* 9C6B04 80241724 3C048025 */  lui       $a0, %hi(D_80251C60_9D7040)
/* 9C6B08 80241728 8C841C60 */  lw        $a0, %lo(D_80251C60_9D7040)($a0)
...
/* 9C6B64 80241784 3C048025 */  lui       $a0, %hi(D_80251C40_9D7020)
/* 9C6B68 80241788 8C841C40 */  lw        $a0, %lo(D_80251C40_9D7020)($a0)
/* 9C6B6C 8024178C 0C048D70 */  jal       func_801235C0
