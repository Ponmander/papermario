...
/* 9C6948 80241568 3C108025 */  lui       $s0, %hi(D_80251C60_9D7040)
/* 9C694C 8024156C 26101C60 */  addiu     $s0, $s0, %lo(D_80251C60_9D7040)
...
/* 9C69B8 802415D8 3C018025 */  lui       $at, %hi(D_80251C64_9D7044)
/* 9C69BC 802415DC AC221C64 */  sw        $v0, %lo(D_80251C64_9D7044)($at)
...
/* 9C6A38 80241658 3C018025 */  lui       $at, %hi(D_80251C68_9D7048)
/* 9C6A3C 8024165C AC221C68 */  sw        $v0, %lo(D_80251C68_9D7048)($at)
...
.L80241674:
/* 9C6A54 80241674 3C028025 */  lui       $v0, %hi(D_80251C60_9D7040)
/* 9C6A58 80241678 8C421C60 */  lw        $v0, %lo(D_80251C60_9D7040)($v0)
