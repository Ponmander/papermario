...
/* CF8C04 80241094 3C038025 */  lui       $v1, %hi(D_8024DF1C_D05A8C)
/* CF8C08 80241098 8C63DF1C */  lw        $v1, %lo(D_8024DF1C_D05A8C)($v1)
/* CF8C0C 8024109C 8C620000 */  lw        $v0, ($v1)
/* CF8C10 802410A0 3C048025 */  lui       $a0, %hi(D_8024DF20_D05A90)
/* CF8C14 802410A4 8C84DF20 */  lw        $a0, %lo(D_8024DF20_D05A90)($a0)
...
.L802410BC:
/* CF8C2C 802410BC 3C048025 */  lui       $a0, %hi(D_8024DF18_D05A88)
/* CF8C30 802410C0 8C84DF18 */  lw        $a0, %lo(D_8024DF18_D05A88)($a0)
...
/* CF8C8C 8024111C 3C048025 */  lui       $a0, %hi(D_8024DEF8_D05A68)
/* CF8C90 80241120 8C84DEF8 */  lw        $a0, %lo(D_8024DEF8_D05A68)($a0)
