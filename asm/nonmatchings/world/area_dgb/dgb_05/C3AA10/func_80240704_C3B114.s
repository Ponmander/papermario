...
/* C3B1E8 802407D8 3C028011 */  lui       $v0, %hi(D_8010EBB0_B095C0)
/* C3B1EC 802407DC 8042EBB0 */  lb        $v0, %lo(D_8010EBB0_B095C0)($v0)
...
/* C3B208 802407F8 3C028011 */  lui       $v0, %hi(D_8010EBB0_B095C0)
/* C3B20C 802407FC 8042EBB0 */  lb        $v0, %lo(D_8010EBB0_B095C0)($v0)
...
/* C3B224 80240814 3C038011 */  lui       $v1, %hi(D_8010EBB0_B095C0)
/* C3B228 80240818 8063EBB0 */  lb        $v1, %lo(D_8010EBB0_B095C0)($v1)
...
/* C3B254 80240844 3C028011 */  lui       $v0, %hi(D_8010C930_B07340)
/* C3B258 80240848 8C42C930 */  lw        $v0, %lo(D_8010C930_B07340)($v0)
