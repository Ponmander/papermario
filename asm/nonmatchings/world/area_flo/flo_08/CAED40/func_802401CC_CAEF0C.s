...
/* CAEF5C 8024021C 3C148024 */  lui       $s4, %hi(D_80241FB8_CB0CF8)
/* CAEF60 80240220 26941FB8 */  addiu     $s4, $s4, %lo(D_80241FB8_CB0CF8)
/* CAEF64 80240224 0260882D */  daddu     $s1, $s3, $zero
/* CAEF68 80240228 8EA200B4 */  lw        $v0, 0xb4($s5)
/* CAEF6C 8024022C 3C038024 */  lui       $v1, %hi(D_80241FB0_CB0CF0)
/* CAEF70 80240230 24631FB0 */  addiu     $v1, $v1, %lo(D_80241FB0_CB0CF0)
...
/* CAEFA8 80240268 3C068009 */  lui       $a2, %hi(D_8008EF20_AFDC60)
/* CAEFAC 8024026C 24C6EF20 */  addiu     $a2, $a2, %lo(D_8008EF20_AFDC60)
...
/* CAEFD8 80240298 3C06800F */  lui       $a2, %hi(D_800F7F00_B66C40)
/* CAEFDC 8024029C 24C67F00 */  addiu     $a2, $a2, %lo(D_800F7F00_B66C40)
...
.L802402D8:
/* CAF018 802402D8 3C06800F */  lui       $a2, %hi(D_800F7F40_B66C80)
/* CAF01C 802402DC 24C67F40 */  addiu     $a2, $a2, %lo(D_800F7F40_B66C80)
...
/* CAF0EC 802403AC 3C038009 */  lui       $v1, %hi(D_8008EF20_AFDC60)
/* CAF0F0 802403B0 00621821 */  addu      $v1, $v1, $v0
/* CAF0F4 802403B4 8C63EF20 */  lw        $v1, %lo(D_8008EF20_AFDC60)($v1)
