...
/* 31B67C 802BD65C 3C168011 */  lui       $s6, %hi(D_8010EBB0_16CBD0)
/* 31B680 802BD660 26D6EBB0 */  addiu     $s6, $s6, %lo(D_8010EBB0_16CBD0)
...
/* 31B6B0 802BD690 0C0AF57D */  jal       func_802BD5F4_31B614
...
.L802BD6B4:
/* 31B6D4 802BD6B4 3C02802C */  lui       $v0, %hi(D_802BEC54_31CC74)
/* 31B6D8 802BD6B8 8C42EC54 */  lw        $v0, %lo(D_802BEC54_31CC74)($v0)
...
/* 31B72C 802BD70C 3C01802C */  lui       $at, %hi(D_802BEC50_31CC70)
/* 31B730 802BD710 AC22EC50 */  sw        $v0, %lo(D_802BEC50_31CC70)($at)
.L802BD714:
...
/* 31B748 802BD728 3C01802C */  lui       $at, %hi(jtbl_802BEBC8_31CBE8)
/* 31B74C 802BD72C 00220821 */  addu      $at, $at, $v0
/* 31B750 802BD730 8C22EBC8 */  lw        $v0, %lo(jtbl_802BEBC8_31CBE8)($at)
/* 31B754 802BD734 00400008 */  jr        $v0
/* 31B758 802BD738 00000000 */   nop
glabel L802BD73C_31B75C
...
/* 31B7A0 802BD780 3C01802C */  lui       $at, %hi(D_802BEC64_31CC84)
/* 31B7A4 802BD784 AC24EC64 */  sw        $a0, %lo(D_802BEC64_31CC84)($at)
/* 31B7A8 802BD788 3C01802C */  lui       $at, %hi(D_802BEB40_31CB60)
/* 31B7AC 802BD78C AC20EB40 */  sw        $zero, %lo(D_802BEB40_31CB60)($at)
/* 31B7B0 802BD790 3C01802C */  lui       $at, %hi(D_802BEC6C_31CC8C)
/* 31B7B4 802BD794 AC20EC6C */  sw        $zero, %lo(D_802BEC6C_31CC8C)($at)
...
/* 31B7D4 802BD7B4 3C01802C */  lui       $at, %hi(D_802BEC58_31CC78)
/* 31B7D8 802BD7B8 AC22EC58 */  sw        $v0, %lo(D_802BEC58_31CC78)($at)
...
/* 31B8A8 802BD888 3C01802C */  lui       $at, %hi(D_802BEC70_31CC90)
/* 31B8AC 802BD88C E424EC70 */  swc1      $f4, %lo(D_802BEC70_31CC90)($at)
/* 31B8B0 802BD890 3C01802C */  lui       $at, %hi(D_802BEC74_31CC94)
/* 31B8B4 802BD894 E422EC74 */  swc1      $f2, %lo(D_802BEC74_31CC94)($at)
/* 31B8B8 802BD898 3C01802C */  lui       $at, %hi(D_802BEC78_31CC98)
/* 31B8BC 802BD89C E420EC78 */  swc1      $f0, %lo(D_802BEC78_31CC98)($at)
/* 31B8C0 802BD8A0 0C00A7E7 */  jal       add_vec2D_polar
/* 31B8C4 802BD8A4 26050068 */   addiu    $a1, $s0, 0x68
/* 31B8C8 802BD8A8 3C02802C */  lui       $v0, %hi(D_802BEC58_31CC78)
/* 31B8CC 802BD8AC 8C42EC58 */  lw        $v0, %lo(D_802BEC58_31CC78)($v0)
...
/* 31BAB0 802BDA90 3C01802C */  lui       $at, %hi(D_802BEC60_31CC80)
/* 31BAB4 802BDA94 AC20EC60 */  sw        $zero, %lo(D_802BEC60_31CC80)($at)
...
/* 31BB14 802BDAF4 3C03802C */  lui       $v1, %hi(D_802BEC60_31CC80)
/* 31BB18 802BDAF8 2463EC60 */  addiu     $v1, $v1, %lo(D_802BEC60_31CC80)
...
/* 31BBF0 802BDBD0 3C038011 */  lui       $v1, %hi(D_8010C97A_16A99A)
/* 31BBF4 802BDBD4 9463C97A */  lhu       $v1, %lo(D_8010C97A_16A99A)($v1)
...
/* 31BC14 802BDBF4 0C0AF451 */  jal       func_802BD144_31B164
...
/* 31BC64 802BDC44 3C01802C */  lui       $at, %hi(D_802BEC5C_31CC7C)
/* 31BC68 802BDC48 AC20EC5C */  sw        $zero, %lo(D_802BEC5C_31CC7C)($at)
...
/* 31BC98 802BDC78 3C01802C */  lui       $at, %hi(D_802BEB40_31CB60)
/* 31BC9C 802BDC7C AC22EB40 */  sw        $v0, %lo(D_802BEB40_31CB60)($at)
...
/* 31BD04 802BDCE4 3C11802C */  lui       $s1, %hi(D_802BEC64_31CC84)
/* 31BD08 802BDCE8 2631EC64 */  addiu     $s1, $s1, %lo(D_802BEC64_31CC84)
...
/* 31BD40 802BDD20 3C01802C */  lui       $at, %hi(D_802BEC60_31CC80)
/* 31BD44 802BDD24 AC20EC60 */  sw        $zero, %lo(D_802BEC60_31CC80)($at)
...
/* 31C08C 802BE06C 0C0AF45F */  jal       func_802BD17C_31B19C
...
/* 31C134 802BE114 3C01802C */  lui       $at, %hi(D_802BEC18_31CC38)
/* 31C138 802BE118 D424EC18 */  ldc1      $f4, %lo(D_802BEC18_31CC38)($at)
/* 31C13C 802BE11C 46000021 */  cvt.d.s   $f0, $f0
/* 31C140 802BE120 24020008 */  addiu     $v0, $zero, 8
/* 31C144 802BE124 3C01802C */  lui       $at, %hi(D_802BEC50_31CC70)
/* 31C148 802BE128 AC22EC50 */  sw        $v0, %lo(D_802BEC50_31CC70)($at)
/* 31C14C 802BE12C 080AF87B */  j         .L802BE1EC
/* 31C150 802BE130 46220001 */   sub.d    $f0, $f0, $f2
.L802BE134:
/* 31C154 802BE134 3C03802C */  lui       $v1, %hi(D_802BEB40_31CB60)
/* 31C158 802BE138 8C63EB40 */  lw        $v1, %lo(D_802BEB40_31CB60)($v1)
...
/* 31C180 802BE160 3C01802C */  lui       $at, %hi(D_802BEC50_31CC70)
/* 31C184 802BE164 AC22EC50 */  sw        $v0, %lo(D_802BEC50_31CC70)($at)
...
/* 31C204 802BE1E4 3C01802C */  lui       $at, %hi(D_802BEC20_31CC40)
/* 31C208 802BE1E8 D424EC20 */  ldc1      $f4, %lo(D_802BEC20_31CC40)($at)
.L802BE1EC:
...
/* 31C320 802BE300 3C01802C */  lui       $at, %hi(D_802BEC28_31CC48)
/* 31C324 802BE304 D424EC28 */  ldc1      $f4, %lo(D_802BEC28_31CC48)($at)
...
.L802BE354:
/* 31C374 802BE354 3C03802C */  lui       $v1, %hi(D_802BEC50_31CC70)
/* 31C378 802BE358 2463EC50 */  addiu     $v1, $v1, %lo(D_802BEC50_31CC70)
...
glabel L802BE37C_31C39C
/* 31C39C 802BE37C 3C03802C */  lui       $v1, %hi(D_802BEC50_31CC70)
/* 31C3A0 802BE380 2463EC50 */  addiu     $v1, $v1, %lo(D_802BEC50_31CC70)
...
/* 31C3F0 802BE3D0 3C01802C */  lui       $at, %hi(D_802BEC70_31CC90)
/* 31C3F4 802BE3D4 C42CEC70 */  lwc1      $f12, %lo(D_802BEC70_31CC90)($at)
/* 31C3F8 802BE3D8 3C01802C */  lui       $at, %hi(D_802BEC78_31CC98)
/* 31C3FC 802BE3DC C42EEC78 */  lwc1      $f14, %lo(D_802BEC78_31CC98)($at)
...
/* 31C470 802BE450 3C01802C */  lui       $at, %hi(D_802BEC30_31CC50)
/* 31C474 802BE454 D422EC30 */  ldc1      $f2, %lo(D_802BEC30_31CC50)($at)
...
.L802BE5DC:
/* 31C5FC 802BE5DC 3C02802C */  lui       $v0, %hi(D_802BEC6C_31CC8C)
/* 31C600 802BE5E0 8C42EC6C */  lw        $v0, %lo(D_802BEC6C_31CC8C)($v0)
/* 31C604 802BE5E4 10400025 */  beqz      $v0, .L802BE67C
/* 31C608 802BE5E8 00000000 */   nop
/* 31C60C 802BE5EC 3C04802C */  lui       $a0, %hi(D_802BEC68_31CC88)
/* 31C610 802BE5F0 8C84EC68 */  lw        $a0, %lo(D_802BEC68_31CC88)($a0)
...
/* 31C634 802BE614 3C02802C */  lui       $v0, %hi(D_802BEC58_31CC78)
/* 31C638 802BE618 8C42EC58 */  lw        $v0, %lo(D_802BEC58_31CC78)($v0)
...
/* 31C72C 802BE70C 3C11802C */  lui       $s1, %hi(D_802BEC64_31CC84)
/* 31C730 802BE710 2631EC64 */  addiu     $s1, $s1, %lo(D_802BEC64_31CC84)
...
/* 31C760 802BE740 3C01802C */  lui       $at, %hi(D_802BEB40_31CB60)
/* 31C764 802BE744 AC20EB40 */  sw        $zero, %lo(D_802BEB40_31CB60)($at)
...
/* 31C798 802BE778 3C11802C */  lui       $s1, %hi(D_802BEC6C_31CC8C)
/* 31C79C 802BE77C 2631EC6C */  addiu     $s1, $s1, %lo(D_802BEC6C_31CC8C)
/* 31C7A0 802BE780 8E220000 */  lw        $v0, ($s1)
/* 31C7A4 802BE784 10400006 */  beqz      $v0, .L802BE7A0
/* 31C7A8 802BE788 00000000 */   nop
/* 31C7AC 802BE78C 3C04802C */  lui       $a0, %hi(D_802BEC68_31CC88)
/* 31C7B0 802BE790 8C84EC68 */  lw        $a0, %lo(D_802BEC68_31CC88)($a0)
/* 31C7B4 802BE794 0C04D06C */  jal       func_801341B0
/* 31C7B8 802BE798 00000000 */   nop
/* 31C7BC 802BE79C AE200000 */  sw        $zero, ($s1)
.L802BE7A0:
/* 31C7C0 802BE7A0 3C01802C */  lui       $at, %hi(D_802BEC54_31CC74)
/* 31C7C4 802BE7A4 AC20EC54 */  sw        $zero, %lo(D_802BEC54_31CC74)($at)
