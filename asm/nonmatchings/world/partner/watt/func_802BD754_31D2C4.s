...
/* 31D2E0 802BD770 3C158011 */  lui       $s5, %hi(D_8010EBB0_16E720)
/* 31D2E4 802BD774 26B5EBB0 */  addiu     $s5, $s5, %lo(D_8010EBB0_16E720)
...
/* 31D300 802BD790 0C0AF5C4 */  jal       func_802BD710_31D280
...
/* 31D378 802BD808 3C01802C */  lui       $at, %hi(D_802BE304_31DE74)
/* 31D37C 802BD80C AC22E304 */  sw        $v0, %lo(D_802BE304_31DE74)($at)
...
/* 31D398 802BD828 3C01802C */  lui       $at, %hi(D_802BE304_31DE74)
/* 31D39C 802BD82C AC22E304 */  sw        $v0, %lo(D_802BE304_31DE74)($at)
/* 31D3A0 802BD830 080AF61E */  j         .L802BD878
/* 31D3A4 802BD834 00000000 */   nop
.L802BD838:
/* 31D3A8 802BD838 24020028 */  addiu     $v0, $zero, 0x28
/* 31D3AC 802BD83C 3C01802C */  lui       $at, %hi(D_802BE304_31DE74)
/* 31D3B0 802BD840 AC22E304 */  sw        $v0, %lo(D_802BE304_31DE74)($at)
/* 31D3B4 802BD844 080AF61E */  j         .L802BD878
/* 31D3B8 802BD848 00000000 */   nop
.L802BD84C:
/* 31D3BC 802BD84C A2A00001 */  sb        $zero, 1($s5)
/* 31D3C0 802BD850 0C0AF805 */  jal       func_802BE014_31DB84
...
/* 31D3D8 802BD868 3C01802C */  lui       $at, %hi(D_802BE304_31DE74)
/* 31D3DC 802BD86C AC22E304 */  sw        $v0, %lo(D_802BE304_31DE74)($at)
/* 31D3E0 802BD870 24020002 */  addiu     $v0, $zero, 2
/* 31D3E4 802BD874 AE620074 */  sw        $v0, 0x74($s3)
.L802BD878:
/* 31D3E8 802BD878 3C10802C */  lui       $s0, %hi(D_802BE304_31DE74)
/* 31D3EC 802BD87C 2610E304 */  addiu     $s0, $s0, %lo(D_802BE304_31DE74)
...
.L802BD930:
/* 31D4A0 802BD930 3C14802C */  lui       $s4, %hi(D_802BE304_31DE74)
/* 31D4A4 802BD934 2694E304 */  addiu     $s4, $s4, %lo(D_802BE304_31DE74)
...
/* 31D514 802BD9A4 3C01802C */  lui       $at, %hi(D_802BE30C_31DE7C)
/* 31D518 802BD9A8 AC30E30C */  sw        $s0, %lo(D_802BE30C_31DE7C)($at)
...
/* 31D5CC 802BDA5C 3C01802C */  lui       $at, %hi(D_802BE30C_31DE7C)
/* 31D5D0 802BDA60 AC24E30C */  sw        $a0, %lo(D_802BE30C_31DE7C)($at)
...
/* 31D710 802BDBA0 0C0AF805 */  jal       func_802BE014_31DB84
...
.L802BDBB8:
/* 31D728 802BDBB8 0C0AF81C */  jal       func_802BE070_31DBE0
...
.L802BDC1C:
/* 31D78C 802BDC1C 3C10802C */  lui       $s0, %hi(D_802BE304_31DE74)
/* 31D790 802BDC20 2610E304 */  addiu     $s0, $s0, %lo(D_802BE304_31DE74)
...
/* 31D7D4 802BDC64 3C01802C */  lui       $at, %hi(D_802BE30C_31DE7C)
/* 31D7D8 802BDC68 AC20E30C */  sw        $zero, %lo(D_802BE30C_31DE7C)($at)
...
.L802BDCA4:
/* 31D814 802BDCA4 3C03802C */  lui       $v1, %hi(D_802BE310_31DE80)
/* 31D818 802BDCA8 8C63E310 */  lw        $v1, %lo(D_802BE310_31DE80)($v1)
