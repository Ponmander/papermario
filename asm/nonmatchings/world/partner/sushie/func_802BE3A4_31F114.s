...
/* 31F148 802BE3D8 3C148011 */  lui       $s4, %hi(D_8010EBB0_16F920)
/* 31F14C 802BE3DC 2694EBB0 */  addiu     $s4, $s4, %lo(D_8010EBB0_16F920)
...
/* 31F174 802BE404 3C01802C */  lui       $at, %hi(D_802BFEFC_320C6C)
/* 31F178 802BE408 AC20FEFC */  sw        $zero, %lo(D_802BFEFC_320C6C)($at)
/* 31F17C 802BE40C 3C01802C */  lui       $at, %hi(D_802BFEF8_320C68)
/* 31F180 802BE410 AC20FEF8 */  sw        $zero, %lo(D_802BFEF8_320C68)($at)
/* 31F184 802BE414 3C01802C */  lui       $at, %hi(D_802BFF00_320C70)
/* 31F188 802BE418 AC20FF00 */  sw        $zero, %lo(D_802BFF00_320C70)($at)
/* 31F18C 802BE41C 3C01802C */  lui       $at, %hi(D_802BFF04_320C74)
/* 31F190 802BE420 AC20FF04 */  sw        $zero, %lo(D_802BFF04_320C74)($at)
/* 31F194 802BE424 3C01802C */  lui       $at, %hi(D_802BFF08_320C78)
/* 31F198 802BE428 AC20FF08 */  sw        $zero, %lo(D_802BFF08_320C78)($at)
...
/* 31F1D0 802BE460 3C01802C */  lui       $at, %hi(jtbl_802BFE68_320BD8)
/* 31F1D4 802BE464 00220821 */  addu      $at, $at, $v0
/* 31F1D8 802BE468 8C22FE68 */  lw        $v0, %lo(jtbl_802BFE68_320BD8)($at)
/* 31F1DC 802BE46C 00400008 */  jr        $v0
/* 31F1E0 802BE470 00000000 */   nop
glabel L802BE474_31F1E4
...
/* 31F268 802BE4F8 3C01802C */  lui       $at, %hi(D_802BFEEC_320C5C)
/* 31F26C 802BE4FC AC30FEEC */  sw        $s0, %lo(D_802BFEEC_320C5C)($at)
...
/* 31F2E0 802BE570 3C01802C */  lui       $at, %hi(D_802BFEE4_320C54)
/* 31F2E4 802BE574 AC20FEE4 */  sw        $zero, %lo(D_802BFEE4_320C54)($at)
/* 31F2E8 802BE578 3C01802C */  lui       $at, %hi(D_802BFEE8_320C58)
/* 31F2EC 802BE57C AC20FEE8 */  sw        $zero, %lo(D_802BFEE8_320C58)($at)
/* 31F2F0 802BE580 AEA00078 */  sw        $zero, 0x78($s5)
/* 31F2F4 802BE584 080AFD3C */  j         .L802BF4F0
/* 31F2F8 802BE588 AEB00070 */   sw       $s0, 0x70($s5)
glabel L802BE58C_31F2FC
...
/* 31F3A0 802BE630 0C0AF8A0 */  jal       func_802BE280_31EFF0
...
/* 31F3CC 802BE65C 3C01802C */  lui       $at, %hi(D_802BFEEC_320C5C)
/* 31F3D0 802BE660 AC22FEEC */  sw        $v0, %lo(D_802BFEEC_320C5C)($at)
...
/* 31F86C 802BEAFC 3C01802C */  lui       $at, %hi(D_802BFEE4_320C54)
/* 31F870 802BEB00 AC20FEE4 */  sw        $zero, %lo(D_802BFEE4_320C54)($at)
/* 31F874 802BEB04 3C01802C */  lui       $at, %hi(D_802BFEE8_320C58)
/* 31F878 802BEB08 AC20FEE8 */  sw        $zero, %lo(D_802BFEE8_320C58)($at)
/* 31F87C 802BEB0C AEA00078 */  sw        $zero, 0x78($s5)
/* 31F880 802BEB10 080AFD3C */  j         .L802BF4F0
/* 31F884 802BEB14 AEA20070 */   sw       $v0, 0x70($s5)
glabel L802BEB18_31F888
...
/* 31F8A0 802BEB30 3C10802C */  lui       $s0, %hi(D_802BFEE4_320C54)
/* 31F8A4 802BEB34 2610FEE4 */  addiu     $s0, $s0, %lo(D_802BFEE4_320C54)
...
/* 31F914 802BEBA4 0C0AF483 */  jal       func_802BD20C_31DF7C
...
.L802BEBE4:
/* 31F954 802BEBE4 3C01802C */  lui       $at, %hi(D_802BFEF8_320C68)
/* 31F958 802BEBE8 C420FEF8 */  lwc1      $f0, %lo(D_802BFEF8_320C68)($at)
...
.L802BECAC:
/* 31FA1C 802BECAC 3C06802C */  lui       $a2, %hi(D_802BFEE4_320C54)
/* 31FA20 802BECB0 8CC6FEE4 */  lw        $a2, %lo(D_802BFEE4_320C54)($a2)
...
/* 31FAA0 802BED30 3C01802C */  lui       $at, %hi(D_802BFEE0_320C50)
/* 31FAA4 802BED34 C420FEE0 */  lwc1      $f0, %lo(D_802BFEE0_320C50)($at)
...
.L802BED5C:
/* 31FACC 802BED5C 3C01802C */  lui       $at, %hi(D_802BFEF8_320C68)
/* 31FAD0 802BED60 C420FEF8 */  lwc1      $f0, %lo(D_802BFEF8_320C68)($at)
...
/* 31FB64 802BEDF4 3C01802C */  lui       $at, %hi(D_802BFEE0_320C50)
/* 31FB68 802BEDF8 C420FEE0 */  lwc1      $f0, %lo(D_802BFEE0_320C50)($at)
...
/* 31FB98 802BEE28 3C01802C */  lui       $at, %hi(D_802BFEE0_320C50)
/* 31FB9C 802BEE2C C422FEE0 */  lwc1      $f2, %lo(D_802BFEE0_320C50)($at)
...
/* 31FBC4 802BEE54 3C02802C */  lui       $v0, %hi(D_802BFEF0_320C60)
/* 31FBC8 802BEE58 8C42FEF0 */  lw        $v0, %lo(D_802BFEF0_320C60)($v0)
...
.L802BEE68:
/* 31FBD8 802BEE68 3C02802C */  lui       $v0, %hi(D_802BFEF4_320C64)
/* 31FBDC 802BEE6C 8C42FEF4 */  lw        $v0, %lo(D_802BFEF4_320C64)($v0)
...
/* 31FC6C 802BEEFC 3C028011 */  lui       $v0, %hi(D_8010C97A_16D6EA)
/* 31FC70 802BEF00 9442C97A */  lhu       $v0, %lo(D_8010C97A_16D6EA)($v0)
...
.L802BEF3C:
/* 31FCAC 802BEF3C 3C03802C */  lui       $v1, %hi(D_802BFEE4_320C54)
/* 31FCB0 802BEF40 8C63FEE4 */  lw        $v1, %lo(D_802BFEE4_320C54)($v1)
...
/* 31FCC0 802BEF50 3C03802C */  lui       $v1, %hi(D_802BFEE8_320C58)
/* 31FCC4 802BEF54 8C63FEE8 */  lw        $v1, %lo(D_802BFEE8_320C58)($v1)
...
/* 31FD18 802BEFA8 3C01802C */  lui       $at, %hi(D_802BFEF0_320C60)
/* 31FD1C 802BEFAC AC20FEF0 */  sw        $zero, %lo(D_802BFEF0_320C60)($at)
...
/* 3201FC 802BF48C 3C01802C */  lui       $at, %hi(D_802BFEEC_320C5C)
/* 320200 802BF490 AC20FEEC */  sw        $zero, %lo(D_802BFEEC_320C5C)($at)
