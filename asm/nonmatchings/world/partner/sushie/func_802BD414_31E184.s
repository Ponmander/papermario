...
/* 31E1BC 802BD44C 0C0AF483 */  jal       func_802BD20C_31DF7C
...
/* 31E1CC 802BD45C 3C158011 */  lui       $s5, %hi(D_8010EBB0_16F920)
/* 31E1D0 802BD460 26B5EBB0 */  addiu     $s5, $s5, %lo(D_8010EBB0_16F920)
/* 31E1D4 802BD464 3C118016 */  lui       $s1, %hi(gCollisionStatus)
/* 31E1D8 802BD468 2631A550 */  addiu     $s1, $s1, %lo(gCollisionStatus)
/* 31E1DC 802BD46C 3C02802C */  lui       $v0, %hi(D_802BFEE4_320C54)
/* 31E1E0 802BD470 8C42FEE4 */  lw        $v0, %lo(D_802BFEE4_320C54)($v0)
...
/* 31E218 802BD4A8 3C02802C */  lui       $v0, %hi(D_802BFDB8_320B28)
/* 31E21C 802BD4AC 2442FDB8 */  addiu     $v0, $v0, %lo(D_802BFDB8_320B28)
/* 31E220 802BD4B0 3C01802C */  lui       $at, %hi(D_802BFDB0_320B20)
/* 31E224 802BD4B4 C422FDB0 */  lwc1      $f2, %lo(D_802BFDB0_320B20)($at)
...
/* 31E260 802BD4F0 3C01802C */  lui       $at, %hi(D_802BFDB0_320B20)
/* 31E264 802BD4F4 C422FDB0 */  lwc1      $f2, %lo(D_802BFDB0_320B20)($at)
...
/* 31E280 802BD510 3C02802C */  lui       $v0, %hi(D_802BFDB8_320B28)
/* 31E284 802BD514 2442FDB8 */  addiu     $v0, $v0, %lo(D_802BFDB8_320B28)
...
.L802BD528:
/* 31E298 802BD528 3C02802C */  lui       $v0, %hi(D_802BFDB8_320B28)
/* 31E29C 802BD52C 2442FDB8 */  addiu     $v0, $v0, %lo(D_802BFDB8_320B28)
...
.L802BD544:
/* 31E2B4 802BD544 3C02802C */  lui       $v0, %hi(D_802BFDBC_320B2C)
/* 31E2B8 802BD548 2442FDBC */  addiu     $v0, $v0, %lo(D_802BFDBC_320B2C)
/* 31E2BC 802BD54C 3C01802C */  lui       $at, %hi(D_802BFDB4_320B24)
/* 31E2C0 802BD550 C424FDB4 */  lwc1      $f4, %lo(D_802BFDB4_320B24)($at)
...
/* 31E2F4 802BD584 3C01802C */  lui       $at, %hi(D_802BFDB4_320B24)
/* 31E2F8 802BD588 C422FDB4 */  lwc1      $f2, %lo(D_802BFDB4_320B24)($at)
...
/* 31E314 802BD5A4 3C02802C */  lui       $v0, %hi(D_802BFDBC_320B2C)
/* 31E318 802BD5A8 2442FDBC */  addiu     $v0, $v0, %lo(D_802BFDBC_320B2C)
...
.L802BD5BC:
/* 31E32C 802BD5BC 3C02802C */  lui       $v0, %hi(D_802BFDBC_320B2C)
/* 31E330 802BD5C0 2442FDBC */  addiu     $v0, $v0, %lo(D_802BFDBC_320B2C)
...
.L802BD5D8:
/* 31E348 802BD5D8 3C06802C */  lui       $a2, %hi(D_802BFDB8_320B28)
/* 31E34C 802BD5DC 8CC6FDB8 */  lw        $a2, %lo(D_802BFDB8_320B28)($a2)
/* 31E350 802BD5E0 3C01802C */  lui       $at, %hi(D_802BFDBC_320B2C)
/* 31E354 802BD5E4 C420FDBC */  lwc1      $f0, %lo(D_802BFDBC_320B2C)($at)
...
/* 31E36C 802BD5FC 3C01800B */  lui       $at, %hi(D_800B1DEC_112B5C)
/* 31E370 802BD600 C42C1DEC */  lwc1      $f12, %lo(D_800B1DEC_112B5C)($at)
/* 31E374 802BD604 0C00A6C9 */  jal       clamp_angle
/* 31E378 802BD608 460C0300 */   add.s    $f12, $f0, $f12
/* 31E37C 802BD60C 3C02802C */  lui       $v0, %hi(D_802BFEF8_320C68)
/* 31E380 802BD610 2442FEF8 */  addiu     $v0, $v0, %lo(D_802BFEF8_320C68)
...
/* 31E3E4 802BD674 3C01802C */  lui       $at, %hi(D_802BFEF8_320C68)
/* 31E3E8 802BD678 C420FEF8 */  lwc1      $f0, %lo(D_802BFEF8_320C68)($at)
...
/* 31E404 802BD694 3C01802C */  lui       $at, %hi(D_802BFEFC_320C6C)
/* 31E408 802BD698 E424FEFC */  swc1      $f4, %lo(D_802BFEFC_320C6C)($at)
...
/* 31E434 802BD6C4 3C03802C */  lui       $v1, %hi(D_802BFF00_320C70)
/* 31E438 802BD6C8 2463FF00 */  addiu     $v1, $v1, %lo(D_802BFF00_320C70)
/* 31E43C 802BD6CC 3C02802C */  lui       $v0, %hi(D_802BFF04_320C74)
/* 31E440 802BD6D0 2442FF04 */  addiu     $v0, $v0, %lo(D_802BFF04_320C74)
...
.L802BD6F8:
/* 31E468 802BD6F8 3C02802C */  lui       $v0, %hi(D_802BFEF8_320C68)
/* 31E46C 802BD6FC 2442FEF8 */  addiu     $v0, $v0, %lo(D_802BFEF8_320C68)
/* 31E470 802BD700 C4400000 */  lwc1      $f0, ($v0)
/* 31E474 802BD704 3C01802C */  lui       $at, %hi(D_802BFE50_320BC0)
/* 31E478 802BD708 D422FE50 */  ldc1      $f2, %lo(D_802BFE50_320BC0)($at)
...
/* 31E49C 802BD72C 3C01802C */  lui       $at, %hi(D_802BFDBC_320B2C)
/* 31E4A0 802BD730 E426FDBC */  swc1      $f6, %lo(D_802BFDBC_320B2C)($at)
/* 31E4A4 802BD734 3C01802C */  lui       $at, %hi(D_802BFDB8_320B28)
/* 31E4A8 802BD738 E426FDB8 */  swc1      $f6, %lo(D_802BFDB8_320B28)($at)
.L802BD73C:
/* 31E4AC 802BD73C 27A50028 */  addiu     $a1, $sp, 0x28
/* 31E4B0 802BD740 3C01802C */  lui       $at, %hi(D_802BFEFC_320C6C)
/* 31E4B4 802BD744 C424FEFC */  lwc1      $f4, %lo(D_802BFEFC_320C6C)($at)
...
/* 31E50C 802BD79C 3C01802C */  lui       $at, %hi(D_802BFF00_320C70)
/* 31E510 802BD7A0 E422FF00 */  swc1      $f2, %lo(D_802BFF00_320C70)($at)
/* 31E514 802BD7A4 3C01802C */  lui       $at, %hi(D_802BFF04_320C74)
/* 31E518 802BD7A8 E420FF04 */  swc1      $f0, %lo(D_802BFF04_320C74)($at)
.L802BD7AC:
...
/* 31E5F0 802BD880 3C028011 */  lui       $v0, %hi(D_8010C978_16D6E8)
/* 31E5F4 802BD884 2442C978 */  addiu     $v0, $v0, %lo(D_8010C978_16D6E8)
...
/* 31E618 802BD8A8 3C03802C */  lui       $v1, %hi(D_802BFEF0_320C60)
/* 31E61C 802BD8AC 2463FEF0 */  addiu     $v1, $v1, %lo(D_802BFEF0_320C60)
...
.L802BD8C0:
/* 31E630 802BD8C0 3C01802C */  lui       $at, %hi(D_802BFEF0_320C60)
/* 31E634 802BD8C4 AC20FEF0 */  sw        $zero, %lo(D_802BFEF0_320C60)($at)
.L802BD8C8:
...
.L802BDB1C:
/* 31E88C 802BDB1C 3C11802C */  lui       $s1, %hi(D_802BFEE4_320C54)
/* 31E890 802BDB20 2631FEE4 */  addiu     $s1, $s1, %lo(D_802BFEE4_320C54)
...
/* 31E8D8 802BDB68 0C0AF4DA */  jal       func_802BD368_31E0D8
...
/* 31E904 802BDB94 3C01802C */  lui       $at, %hi(D_802BFEE0_320C50)
/* 31E908 802BDB98 C422FEE0 */  lwc1      $f2, %lo(D_802BFEE0_320C50)($at)
...
/* 31E928 802BDBB8 3C01802C */  lui       $at, %hi(D_802BFEE8_320C58)
/* 31E92C 802BDBBC AC20FEE8 */  sw        $zero, %lo(D_802BFEE8_320C58)($at)
...
.L802BDBDC:
/* 31E94C 802BDBDC 3C04802C */  lui       $a0, %hi(D_802BFEE4_320C54)
/* 31E950 802BDBE0 2484FEE4 */  addiu     $a0, $a0, %lo(D_802BFEE4_320C54)
...
/* 31E974 802BDC04 3C02802C */  lui       $v0, %hi(D_802BFEE8_320C58)
/* 31E978 802BDC08 8C42FEE8 */  lw        $v0, %lo(D_802BFEE8_320C58)($v0)
/* 31E97C 802BDC0C 14400002 */  bnez      $v0, .L802BDC18
/* 31E980 802BDC10 24020002 */   addiu    $v0, $zero, 2
/* 31E984 802BDC14 AC820000 */  sw        $v0, ($a0)
.L802BDC18:
/* 31E988 802BDC18 3C03802C */  lui       $v1, %hi(D_802BFEE8_320C58)
/* 31E98C 802BDC1C 2463FEE8 */  addiu     $v1, $v1, %lo(D_802BFEE8_320C58)
/* 31E990 802BDC20 8C620000 */  lw        $v0, ($v1)
/* 31E994 802BDC24 24420001 */  addiu     $v0, $v0, 1
/* 31E998 802BDC28 AC620000 */  sw        $v0, ($v1)
/* 31E99C 802BDC2C 3C03802C */  lui       $v1, %hi(D_802BFEE4_320C54)
/* 31E9A0 802BDC30 8C63FEE4 */  lw        $v1, %lo(D_802BFEE4_320C54)($v1)
...
/* 31EA1C 802BDCAC 3C01802C */  lui       $at, %hi(D_802BFEE0_320C50)
/* 31EA20 802BDCB0 C420FEE0 */  lwc1      $f0, %lo(D_802BFEE0_320C50)($at)
...
/* 31EA8C 802BDD1C 3C01802C */  lui       $at, %hi(D_802BFEE0_320C50)
/* 31EA90 802BDD20 C420FEE0 */  lwc1      $f0, %lo(D_802BFEE0_320C50)($at)
...
/* 31EAD4 802BDD64 3C11802C */  lui       $s1, %hi(D_802BFEE8_320C58)
/* 31EAD8 802BDD68 2631FEE8 */  addiu     $s1, $s1, %lo(D_802BFEE8_320C58)
...
/* 31EB2C 802BDDBC 3C01802C */  lui       $at, %hi(D_802BFEE0_320C50)
/* 31EB30 802BDDC0 C420FEE0 */  lwc1      $f0, %lo(D_802BFEE0_320C50)($at)
...
.L802BDE10:
/* 31EB80 802BDE10 3C03802C */  lui       $v1, %hi(D_802BFEF4_320C64)
/* 31EB84 802BDE14 2463FEF4 */  addiu     $v1, $v1, %lo(D_802BFEF4_320C64)
...
/* 31EBBC 802BDE4C 3C01802C */  lui       $at, %hi(D_802BFEE0_320C50)
/* 31EBC0 802BDE50 C420FEE0 */  lwc1      $f0, %lo(D_802BFEE0_320C50)($at)
...
.L802BDEAC:
/* 31EC1C 802BDEAC 3C03802C */  lui       $v1, %hi(D_802BFEE8_320C58)
/* 31EC20 802BDEB0 8C63FEE8 */  lw        $v1, %lo(D_802BFEE8_320C58)($v1)
...
/* 31EC68 802BDEF8 3C01802C */  lui       $at, %hi(D_802BFEE4_320C54)
/* 31EC6C 802BDEFC AC22FEE4 */  sw        $v0, %lo(D_802BFEE4_320C54)($at)
.L802BDF00:
...
/* 31ED3C 802BDFCC 3C04802C */  lui       $a0, %hi(D_802BFEE8_320C58)
/* 31ED40 802BDFD0 8C84FEE8 */  lw        $a0, %lo(D_802BFEE8_320C58)($a0)
...
/* 31EDC0 802BE050 3C01802C */  lui       $at, %hi(D_802BFEE0_320C50)
/* 31EDC4 802BE054 C420FEE0 */  lwc1      $f0, %lo(D_802BFEE0_320C50)($at)
...
.L802BE084:
/* 31EDF4 802BE084 3C12802C */  lui       $s2, %hi(D_802BFEE4_320C54)
/* 31EDF8 802BE088 2652FEE4 */  addiu     $s2, $s2, %lo(D_802BFEE4_320C54)
/* 31EDFC 802BE08C 8E430000 */  lw        $v1, ($s2)
/* 31EE00 802BE090 1462006E */  bne       $v1, $v0, .L802BE24C
/* 31EE04 802BE094 00000000 */   nop
/* 31EE08 802BE098 3C03802C */  lui       $v1, %hi(D_802BFF08_320C78)
/* 31EE0C 802BE09C 2463FF08 */  addiu     $v1, $v1, %lo(D_802BFF08_320C78)
/* 31EE10 802BE0A0 C4600000 */  lwc1      $f0, ($v1)
/* 31EE14 802BE0A4 3C01802C */  lui       $at, %hi(D_802BFE58_320BC8)
/* 31EE18 802BE0A8 D422FE58 */  ldc1      $f2, %lo(D_802BFE58_320BC8)($at)
/* 31EE1C 802BE0AC 46000021 */  cvt.d.s   $f0, $f0
/* 31EE20 802BE0B0 46220000 */  add.d     $f0, $f0, $f2
/* 31EE24 802BE0B4 3C01802C */  lui       $at, %hi(D_802BFE60_320BD0)
/* 31EE28 802BE0B8 D424FE60 */  ldc1      $f4, %lo(D_802BFE60_320BD0)($at)
...
/* 31EE5C 802BE0EC 3C04802C */  lui       $a0, %hi(D_802BFEE8_320C58)
/* 31EE60 802BE0F0 8C84FEE8 */  lw        $a0, %lo(D_802BFEE8_320C58)($a0)
...
/* 31EEB0 802BE140 3C01802C */  lui       $at, %hi(D_802BFEE0_320C50)
/* 31EEB4 802BE144 C420FEE0 */  lwc1      $f0, %lo(D_802BFEE0_320C50)($at)
...
/* 31EEF4 802BE184 3C11802C */  lui       $s1, %hi(D_802BFEE0_320C50)
/* 31EEF8 802BE188 2631FEE0 */  addiu     $s1, $s1, %lo(D_802BFEE0_320C50)
...
/* 31EF24 802BE1B4 3C03802C */  lui       $v1, %hi(D_802BFEF4_320C64)
/* 31EF28 802BE1B8 2463FEF4 */  addiu     $v1, $v1, %lo(D_802BFEF4_320C64)
