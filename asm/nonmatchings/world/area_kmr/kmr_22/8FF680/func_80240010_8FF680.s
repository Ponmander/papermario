...
/* 8FF6E4 80240074 3C018025 */  lui       $at, %hi(D_802483C0_907A30)
/* 8FF6E8 80240078 AC2283C0 */  sw        $v0, %lo(D_802483C0_907A30)($at)
/* 8FF6EC 8024007C 3C018025 */  lui       $at, %hi(D_802483C4_907A34)
/* 8FF6F0 80240080 AC2083C4 */  sw        $zero, %lo(D_802483C4_907A34)($at)
.L80240084:
/* 8FF6F4 80240084 3C038025 */  lui       $v1, %hi(D_802483C4_907A34)
/* 8FF6F8 80240088 8C6383C4 */  lw        $v1, %lo(D_802483C4_907A34)($v1)
...
/* 8FF72C 802400BC 3C038025 */  lui       $v1, %hi(D_802483C0_907A30)
/* 8FF730 802400C0 8C6383C0 */  lw        $v1, %lo(D_802483C0_907A30)($v1)
...
/* 8FF74C 802400DC 3C038025 */  lui       $v1, %hi(D_802483C4_907A34)
/* 8FF750 802400E0 8C6383C4 */  lw        $v1, %lo(D_802483C4_907A34)($v1)
...
.L80240128:
/* 8FF798 80240128 3C038025 */  lui       $v1, %hi(D_802483C0_907A30)
/* 8FF79C 8024012C 8C6383C0 */  lw        $v1, %lo(D_802483C0_907A30)($v1)
...
/* 8FF7B8 80240148 3C038025 */  lui       $v1, %hi(D_802483C4_907A34)
/* 8FF7BC 8024014C 8C6383C4 */  lw        $v1, %lo(D_802483C4_907A34)($v1)
...
.L80240194:
/* 8FF804 80240194 3C058025 */  lui       $a1, %hi(D_802483C0_907A30)
/* 8FF808 80240198 8CA583C0 */  lw        $a1, %lo(D_802483C0_907A30)($a1)
/* 8FF80C 8024019C 8CA3000C */  lw        $v1, 0xc($a1)
/* 8FF810 802401A0 2406005A */  addiu     $a2, $zero, 0x5a
/* 8FF814 802401A4 AC640040 */  sw        $a0, 0x40($v1)
/* 8FF818 802401A8 3C048025 */  lui       $a0, %hi(D_802483C4_907A34)
/* 8FF81C 802401AC 248483C4 */  addiu     $a0, $a0, %lo(D_802483C4_907A34)
